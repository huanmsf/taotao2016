...
<div class="easyui-panel" title="Nested Panel" data-options="width:'100%',minHeight:500,noheader:true,border:false" style="padding:10px;">
    <div class="easyui-layout" data-options="fit:true">
        <div data-options="region:'west',split:false" style="width:250px;padding:5px">
            <ul id="contentCategoryTree" class="easyui-tree" data-options="url:'${contextPath}/rest/content/category/list',animate: true,method : 'GET'">
            </ul>
        </div>
        <div data-options="region:'center'" style="padding:5px">
            <table class="easyui-datagrid" id="contentList" data-options="toolbar:contentListToolbar,singleSelect:false,collapsible:true,pagination:true,method:'get',pageSize:20,url:'${contextPath}/rest/content/query/list',queryParams:{categoryId:0}">
		    <thead>
		        <tr>
...
var contentListToolbar = [{
    ...
    handler:function(){
    	...
    	TT.createWindow({
			url : "${contextPath}/rest/page/content-add"
		}); 
    }
},{
    text:'编辑',
    ...
    handler:function(){
		...
		TT.createWindow({
			url : "${contextPath}/rest/page/content-edit",
			onLoad : function(){
    ...
    handler:function(){
    	...
    	$.messager.confirm('确认','确定删除ID为 '+ids+' 的内容吗？',function(r){
    	    if (r){
    	    	var params = {"ids":ids};
            	$.post("${contextPath}/rest/page/content/delete",params, function(data){
        			if(data.status == 200){
